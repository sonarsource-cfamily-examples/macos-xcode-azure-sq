...
// URIs:
:uri-qg-status: https://next.sonarqube.com/sonarqube/dashboard?id=sonarsource-cfamily-examples_macos-xcode-azure-sq_AYAYr_NcQUWaRZD6h1ua
:img-qg-status: https://next.sonarqube.com/sonarqube/api/project_badges/measure?project=sonarsource-cfamily-examples_macos-xcode-azure-sq_AYAYr_NcQUWaRZD6h1ua&metric=alert_status&token=squ_a0683d6d23bc3fa8b93a6befc840c774511333cc
:uri-build-status: https://dev.azure.com/sonarsource-cfamily-examples/macos-xcode-azure-sq/_build/latest?definitionId=2
:img-build-status: https://dev.azure.com/sonarsource-cfamily-examples/macos-xcode-azure-sq/_apis/build/status/sonarsource-cfamily-examples.macos-xcode-azure-sq

image:{img-build-status}[Build Status, link={uri-build-status}]
image:{img-qg-status}[Quality Gate Status,link={uri-qg-status}]

*This project is analysed on https://next.sonarqube.com/sonarqube/dashboard?id=sonarsource-cfamily-examples_macos-xcode-azure-sq_AYAYr_NcQUWaRZD6h1ua[SonarQube]!*
...
* In "Additional Properties" in the "Advanced" section, add the property `sonar.cfamily.compile-commands` with, as its value, the `compile_commands.json` file in the output directory to which the Build Wrapper should write its results (e.g. `build_wrapper_output_directory`)
